...
public class NtfyClientImpl extends AbstractScriptModule implements NtfyClientScripts {

    private final NtfyClient client = new NtfyClient();
    ...
    protected boolean sendMessageImpl(String serverUrl, String topic, String message, String title,
        ...
        return client.sendMessage(serverUrl, topic, message, title, tags, priority, clickAction, attach,
